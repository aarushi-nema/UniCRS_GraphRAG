...
if __name__ == '__main__':
    with open('/home/Nema/UniCRS/src/data/redial/entity2id.json', 'r', encoding='utf-8') as f:
    ...
    process('/home/Nema/UniCRS/src/data/redial/valid_data_dbpedia.jsonl', '/home/Nema/UniCRS/src/data/redial/valid_data_processed.jsonl', movie_set)
    process('/home/Nema/UniCRS/src/data/redial/test_data_dbpedia.jsonl', '/home/Nema/UniCRS/src/data/redial/test_data_processed.jsonl', movie_set)
    process('/home/Nema/UniCRS/src/data/redial/train_data_dbpedia.jsonl', '/home/Nema/UniCRS/src/data/redial/train_data_processed.jsonl', movie_set)

    with open('/home/Nema/UniCRS/src/data/redial/movie_ids.json', 'w', encoding='utf-8') as f:
